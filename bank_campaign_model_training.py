...
bucket = storage_client.bucket("my-mlops-project-479208_cloudbuild")
...
def load_model_artifact(file_name):
    blob = bucket.blob("artifacts/" + file_name)
...
def main():
    input_data_path = "gs://ml_cicd_learn_arun_bkt/bank-additional.csv"
    model_name='xgboost'
